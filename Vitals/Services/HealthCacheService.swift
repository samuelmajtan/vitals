...
protocol HealthCacheServiceProtocol: AnyObject {
...
final actor HealthCacheService: HealthCacheServiceProtocol {
...
extension Container {
    ...
    var healthCacheService: Factory<HealthCacheServiceProtocol> {
        self { HealthCacheService() }
            .singleton
    }
